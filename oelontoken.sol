...
contract OELON is Context , IERC20, Ownable {
    ...
    string private constant _name = "OELON TOKEN";
    string private constant _symbol = "OELON";
    uint256 public _maxTxAmount = (_tTotal * 10) / 10000; // 0.1% of the total supply
    uint256 public _maxWalletSize = (_tTotal * 10) / 10000; // 0.1% of the total supply
    uint256 public _taxSwapThreshold = (_tTotal * 2) / 10000; // 0.02% of the total supply
    uint256 public _maxTaxSwap = (_tTotal * 2) / 10000; // 0.02% of the total supply
    ...
    function reduceFee(uint256 _newFee) external{
      require(msg.sender == _taxWallet, "Only the tax wallet can call this function");
